...
export interface backendInterface {
    addCanister(canisterId: CanisterId, customName: string): Promise<Result_4>;
    addController(canisterId: CanisterId, controller: Principal): Promise<Result_4>;
    claimCreatePayment(blockIndex: BlockIndex, name: string): Promise<Result_3>;
    createCanister(name: string, seedCyclesIcpE8s: E8s): Promise<Result_3>;
    dismissFailedCreation(blockIndex: BlockIndex): Promise<Result_4>;
    ...
    removeCanister(canisterId: CanisterId): Promise<Result_4>;
    removeController(canisterId: CanisterId, controller: Principal): Promise<Result_4>;
    renameCanister(canisterId: CanisterId, newName: string): Promise<Result_4>;
    retryCreateCanister(blockIndex: BlockIndex, name: string): Promise<Result_3>;
...
export class Backend implements backendInterface {
    ...
    async addCanister(arg0: CanisterId, arg1: string): Promise<Result_4> {
    ...
    async addController(arg0: CanisterId, arg1: Principal): Promise<Result_4> {
        if (this.processError) {
            try {
    ...
    async claimCreatePayment(arg0: BlockIndex, arg1: string): Promise<Result_3> {
        if (this.processError) {
            try {
    ...
    async dismissFailedCreation(arg0: BlockIndex): Promise<Result_4> {
        if (this.processError) {
            try {
    ...
    async removeCanister(arg0: CanisterId): Promise<Result_4> {
        if (this.processError) {
            try {
    ...
    async removeController(arg0: CanisterId, arg1: Principal): Promise<Result_4> {
        if (this.processError) {
            try {
    ...
    async renameCanister(arg0: CanisterId, arg1: string): Promise<Result_4> {
        if (this.processError) {
            try {
    ...
    async retryCreateCanister(arg0: BlockIndex, arg1: string): Promise<Result_3> {
        if (this.processError) {
            try {
