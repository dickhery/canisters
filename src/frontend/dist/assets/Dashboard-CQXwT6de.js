import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, n as formatIcp, B as Button, I as useInternetIdentity, S as Server, o as formatCycles, W as Wallet, L as Link, C as CopyableId } from "./index-BkGz-69k.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-BL6orJzL.js";
import { a as useGetMyBalance, q as useTransferIcp, L as Label, I as Input, h as useGetAppPrincipal, c as useListCanisters, p as useGetMyAccount, s as useGetRecentCanisters, t as useGetLowestCyclesCanisters, v as useGetTotalCycles, S as Skeleton, e as useAddCanister } from "./index-DQF_mRsu.js";
import { P as Plus } from "./plus--ohgIQPj.js";
import { A as ArrowUpRight } from "./arrow-up-right-CzJcs09_.js";
/**
...
const CircuitBoard = createLucideIcon("circuit-board", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function DashboardRow({ item, index, ocidPrefix }) {
  const canisterId = item.canisterId.toText();
  const displayName = item.customName ? item.customName.toUpperCase() : "UNNAMED_CANISTER";
  const truncatedId = canisterId.length > 30 ? `${canisterId.slice(0, 14)}...${canisterId.slice(-8)}` : canisterId;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-foreground truncate group-hover:text-primary transition-colors tracking-[0.1em] uppercase", children: displayName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-muted-foreground mt-0.5 truncate tracking-wide", children: truncatedId })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs font-bold text-primary tabular-nums retro-glow-sm", children: formatCycles(item.cycleBalance) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `font-mono text-[9px] px-1.5 py-0.5 border tracking-[0.1em] ${item.isController ? "border-primary/60 text-primary bg-primary/10" : "border-border/40 text-muted-foreground/60 bg-transparent"}`,
              children: item.isController ? "◆CTRL" : "◇NO-CTRL"
            }
          )
        ] }),
...
function DashboardList({
  ...
  if (!items || items.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: onAddClick ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] text-muted-foreground tracking-[0.15em]", children: "> NO_CANISTERS_TRACKED" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-[11px] text-muted-foreground tracking-[0.15em]", children: [
          "> ",
          emptyMessage
        ] })
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0 px-0", "data-ocid": `${ocidPrefix}.list`, children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    DashboardRow,
    {
      item,
      index: i + 1,
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              DashboardList,
              {
                ...
                onAddClick: !recentLoading && (!recentCanisters || recentCanisters.length === 0) ? () => setAddOpen(true) : void 0
              }
            ) })
          ]
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border/40 px-4 py-2 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "h-3.5 w-3.5 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-mono text-xs font-semibold text-primary uppercase tracking-[0.2em] retro-glow-sm", children: "LOW CYCLES" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[9px] px-1.5 border border-primary/30 text-primary/60 tracking-[0.1em] uppercase", children: "ALERT" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
